...
class Announce extends CI_Controller
{
     ...
     */
    private $from_address = 'person@example.com';
    private $from_name = 'Firstname Lastname';
    private $reply_to = 'person@example.com';
    ...
    public function result($component = null)
    {
        ...
        $result_url = sprintf('http://robotics.no-ip.ca/results/team_report?c=%s&s=%s&p=%s&r=%s&k=%s', $component, $id, isset($score->score) ? $i : 0, $j, $score->result_key);
                ...
                $message .= "Here is the judge's score card for your CRC Loops 2017 ".$component." submission: \n";
                $message .= $result_url."\n\n";
    ...
    public function judges()
    {
        ...
        foreach ($judges as $judge) {
            ...
            $message .= 'As indicated last year, we have kept you on our list and hope you will be able to contrinute your talent and experiecne for the CRC Robotics Loops 2017 competiton!';
    ...
    public function instructions()
    {
        ...
        foreach ($judges as $judge) {
            ...
            $message .= "CRC Robotics Loops 2017 !\n\n";

            $message .= "REMINDERS:\n";
            $message .= "- The deadline is February 15th (the competition starts Feb 16):\n";
            ...
            $message .= "If you have any questions, or if you have recevied this message in error, simply reply to this email and I will do my best to help.\n\n";
            $message .= "(A real person monitors this email address.)\n\n";
            $message .= "Sincerely,\nFirstname Lastname\nperson@example.com";
    ...
    public function reminder()
    {
        ...
        foreach ($judges as $judge) {
            ...
            $message = 'Hello '.$judge['firstname'].",\n\n";
            $message .= "You are receiving this email because you are a judge for CRC Robotics Loops 2017\n";
